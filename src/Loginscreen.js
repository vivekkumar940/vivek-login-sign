...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register Here"} primary={true} style={style} onClick={(event) => this.handleClick(event,'student')}/>
       </div>
    ...
    this.state={
      ...
      studentbuttonLabel:'Register Here ',
  ...
  componentWillMount(){
    ...
    var loginmessage = " Register Here";
    this.setState({
  ...
  handleClick(event,userRole){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
          <div>
             <RaisedButton label={"Login Here"} primary={true} style={style} onClick={(event) => this.handleClick(event,userRole)}/>
         </div>
         </MuiThemeProvider>
        </div>
      )
